...
const SIDES = {
  ...
  creative: {
    ...
    tags: ["AI Content", "Mythology", "Side Quest"],
    desc: "I craft AI-powered stories and cinematic worlds. Also founder of AIWITHNOBRAIN — started as a hobby, turned into a whole thing.",
    enter: "/creator",
